...
import HireMeCard from "@/app/components/molecules/HireMeCard/HireMeCard";
...
const Profile: React.FC = () => {
  ...
  const fetchProfile = useCallback(async () => {
    try {
      ...
      setIndustryFocus(
        Array.isArray(data.industry_focus)
          ? data.industry_focus.join(", ")
          : data.industry_focus || "",
      );
      setToolsAndTechnologies(
        Array.isArray(data.tools_and_technologies)
    ...
    for (const [url, key] of urlFields) {
      if (url && url.trim()) {
        try {
          ...
          next[key] = "Invalid URL";
        }
      }
    }
    const rateNum = Number(hourlyRate);
    if (Number.isNaN(rateNum) || rateNum < 0)
      next.hourlyRate = "Must be a positive number";
    setErrors(next);
  ...
  const onSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!validate()) {
      setStatus("Please fix the errors highlighted below before saving.");
      return;
    }
    setSaving(true);
    try {
  ...
  const getRateEstimate = async () => {
    ...
    try {
      ...
      if (
        api.ai &&
        typeof (api.ai as any).estimateFreelancerRate === "function"
      ) {
        ...
        setRateEstimate({
          estimated_rate: 25,
          message:
            "AI rate estimation is not available. Set your rate based on market research.",
        });
      }
    } catch {
      /* ignore */
      ...
      <div className={styles.profileContainer}>
            ...
            <div className={styles.headerActions}>
              ...
              {profileSlug && (
                <Button
                  ...
                  type="button"
                  onClick={() =>
                    window.open(`/freelancers/${profileSlug}`, "_blank")
                  }
        ...
        >
            ...
            <StaggerContainer>
              <StaggerItem className={styles.section}>
                ...
                <Input
                  ...
                  placeholder="A short catchy tagline (max 200 chars)"
                />
                <Textarea
                  id="headline"
                  ...
                  rows={2}
                  placeholder="A detailed one-liner about what you do and your expertise"
                />
                <Textarea
                  id="bio"
                  label="About Me"
            ...
            <StaggerContainer>
              <StaggerItem className={styles.section}>
                ...
                <div className={styles.section}>
                  ...
                  />
                  <small className={styles.skillsInfo}>
                    Separate skills with commas. These appear on your public
                    profile.
                  </small>
                </div>
                <div className={styles.inlineSection}>
                ...
                <div className={styles.inlineSection}>
                  <Select
                    ...
                    value={preferredProjectSize}
                    onChange={(e) => setPreferredProjectSize(e.target.value)}
                ...
                <Input
                  ...
                  placeholder="VS Code, Figma, Docker, AWS..."
                />
              </StaggerItem>
            </StaggerContainer>
          )}
            ...
            <StaggerContainer>
              <StaggerItem className={styles.section}>
                ...
                {workHistory.length === 0 ? (
                  <div className={styles.emptyArrayState}>
                    <p>
                      Add your work experience to stand out to potential clients
                    </p>
                    <Button
                      type="button"
                      variant="outline"
                  ...
                  workHistory.map((w, idx) => (
                    <div key={idx} className={styles.arrayCard}>
                      <div className={styles.arrayCardHeader}>
                        <span className={styles.arrayCardTitle}>
                          Experience #{idx + 1}
                        </span>
                        <button
                          type="button"
                      ...
                      <div className={styles.inlineSection}>
                        <Input
                          ...
                          value={w.company}
                          onChange={(e) =>
                            updateWorkHistory(idx, "company", e.target.value)
                          }
                        />
                        <Input
                          label="Role"
                      ...
                      <Input
                        ...
                        value={w.duration}
                        onChange={(e) =>
                          updateWorkHistory(idx, "duration", e.target.value)
                        }
                      ...
                      <Textarea
                        ...
                        value={w.description}
                        onChange={(e) =>
                          updateWorkHistory(idx, "description", e.target.value)
                        }
                        rows={3}
              ...
              <StaggerItem className={styles.section}>
                ...
                {achievements.length === 0 ? (
                  <div className={styles.emptyArrayState}>
                    <p>
                      Showcase your awards, certifications, and notable
                      accomplishments
                    </p>
                    <Button
                      type="button"
            ...
            <StaggerContainer>
              <StaggerItem className={styles.section}>
                ...
                {education.length === 0 ? (
                  <div className={styles.emptyArrayState}>
                    <p>
                      Add your educational background to build trust with
                      clients
                    </p>
                    <Button
                      type="button"
            ...
            <StaggerContainer>
              <StaggerItem className={styles.section}>
                ...
                <p className={styles.sectionDescription}>
                  Connect your online presence to increase credibility and let
                  clients find you elsewhere.
                </p>
          ...
          {activeSection === "media" && (
            <StaggerContainer>
              <StaggerItem className={styles.section}>
                ...
                <p className={styles.sectionDescription}>
                  Add a video intro, resume, or other materials to make your
                  profile stand out.
                </p>
                <div className={styles.mediaSection}>
                  <div className={styles.mediaCard}>
                    <div className={styles.mediaCardContent}>
                      ...
                      <p>
                        Add a short video pitch to introduce yourself. Upload to
                        YouTube/Vimeo and paste the link.
                      </p>
                      <Input
                        label="Video URL"
                        value={videoIntroUrl}
                  ...
                  <div className={styles.mediaCard}>
                    <div className={styles.mediaCardContent}>
                      <h3>Resume / CV</h3>
                      <p>
                        Link to your resume or CV so clients can review your
              ...
              <StaggerItem className={styles.section}>
                ...
                <div className={styles.settingsCard}>
                  ...
                  <div className={styles.settingRow}>
                    <div>
                      ...
                      <p>
                        Allow reviews and testimonials on your public profile
                      </p>
                    </div>
                ...
                <div className={styles.shareSection}>
                  ...
                  <p className={styles.shareDesc}>
                    Share this link on your resume, social media, or anywhere to
          ...
          <div className={styles.actions}>
            <Button variant="secondary" type="button" onClick={fetchProfile}>
              Reset
            </Button>
            ...
            >
              ...
              <div className={styles.shareModalContent}>
                {shareTab === "links" && (
                  <>
                    <p>
                      Share your freelancer profile to get noticed by potential
                      clients!
                    </p>
                    <div className={styles.shareUrlBox}>
                      <input
                    ...
                    <div className={styles.shareModalButtons}>
                      ...
                      <Button
                        ...
                        onClick={() => {
                          window.open(
                            `mailto:?subject=${encodeURIComponent(`Check out my freelancer profile`)}&body=${encodeURIComponent(`Hi,\n\nCheck out my freelancer profile on MegiLance:\n${profileUrl}\n\n${headline || tagline || ""}`)}`,
                            "_self",
                          );
                        }}
                        fullWidth
                      ...
                      <Button
                        ...
                        onClick={() => {
                          window.open(
                            `https://wa.me/?text=${encodeURIComponent(`Check out my freelancer profile: ${profileUrl}`)}`,
                            "_blank",
                            "noopener",
                          );
                        }}
