// @AI-HINT: Error boundary for admin portal routes
// Next.js error.js convention - catches runtime errors in admin section
'use client';
    ...
    >
      <div className="text-center max-w-lg space-y-5">
        ...
        <p className="text-gray-600 dark:text-gray-400 text-sm max-w-sm mx-auto">
          An unexpected error occurred in the admin panel. Your data is safe and no changes have been made.
        </p>
