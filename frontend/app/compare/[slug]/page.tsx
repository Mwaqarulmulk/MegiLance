...
const competitors: Record<string, CompetitorData> = {
  upwork: {
    ...
    faqs: [
      { question: `Is ${SITE_NAME} better than Upwork?`, answer: `${SITE_NAME} offers 7-factor AI matching, free client-side AI tools (Price Estimator, Proposal Writer, Scope Planner), 0% promotional platform fees during launch, and milestone-based escrow payments.` },
      { question: `How much cheaper is ${SITE_NAME} compared to Upwork?`, answer: `Upwork charges clients payment fees plus freelancers pay 10% service fees. ${SITE_NAME} offers 0% platform fee during our promotional launch period, allowing freelancers to keep 100% of their earnings.` },
