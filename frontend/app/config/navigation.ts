...
export const freelancerNavItems: NavItem[] = [
  ...
  { label: 'AI Suite', href: '/ai', icon: 'Bot', section: 'Intelligence', submenu: [
    ...
    { label: 'Proposal Writer', href: '/ai/proposal-writer', icon: 'PenTool' },
...
export const clientNavItems: NavItem[] = [
  ...
  { label: 'AI Tools', href: '/ai', icon: 'Bot', section: 'Intelligence', submenu: [
    { label: 'AI Overview', href: '/ai', icon: 'Bot' },
    { label: 'Price Estimator', href: '/ai/price-estimator', icon: 'TrendingUp' },
...
export const adminNavItems: NavItem[] = [
  ...
  { label: 'AI Services', href: '/ai', icon: 'Bot', section: 'Intelligence', submenu: [
    ...
    { label: 'AI Price Estimator', href: '/ai/price-estimator', icon: 'TrendingUp' },
    { label: 'AI Invoice Generator', href: '/ai/invoice-generator', icon: 'FileText' },
  ]},
