...
export const SEO_KEYWORDS = {
  ...
  transactional: [
    ...
    // Semrush US & Global Client Acquisition & High-Intent Queries
    'hire remote software engineers', 'hire full stack developer us', 'hire react developers global',
    'hire python developers for startups', 'hire ai engineer usa', 'hire nextjs developer remote',
    'hire dedicated software developers', 'best site to hire freelance developers',
    'how to hire remote software engineers', 'software development cost estimator',
    'freelance project budget calculator', 'hire vetted freelance engineers',
    'top freelance software engineers', 'hire cloud architect us', 'hire machine learning engineer',
  ],
  ...
  informational: [
    ...
    // Semrush US Client Disruption & Alternatives
    'upwork alternative for businesses', 'fiverr alternative for enterprise',
    'toptal alternative for startups', 'cheaper than toptal',
    'hire developers without upwork fees', 'how to hire remote software engineers',
    'how to hire web developers', 'best platform to hire software engineers',
  ],
...
export const buildFAQJsonLd = buildFaqJsonLd;
