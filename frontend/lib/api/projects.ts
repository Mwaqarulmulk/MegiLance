...
export const projectsApi = {
  ...
  get: (projectId: ResourceId) => apiFetch(`/projects/${projectId}`),
...
export const contractsApi = {
  ...
  get: (contractId: ResourceId) => apiFetch(`/contracts/${contractId}`),
...
export const proposalsApi = {
  ...
  get: (proposalId: ResourceId) => apiFetch(`/proposals/${proposalId}`),
...
export const milestonesApi = {
  ...
  list: (contractId: ResourceId) =>
    apiFetch(`/milestones?contract_id=${contractId}`),
  ...
  submit: (
    id: ResourceId,
    data: { deliverables: string; submission_notes?: string },
  ) =>
