# Codex Configuration - MegiLance 2.0
...
**Codex's Role**: Full-stack development assistant focused on Next.js (frontend) and FastAPI (backend) with emphasis on type safety, performance, and AI integration.
