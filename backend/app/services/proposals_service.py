...
def create_proposal(freelancer_id: int, proposal_data: dict) -> Optional[dict]:
    ...
    insert_result = execute_query(
        ...
        [
            proposal_data["project_id"],
            freelancer_id,
            proposal_data.get("cover_letter") or "",
            bid_amount,
            proposal_data.get("estimated_hours") or 0,
            proposal_data.get("hourly_rate") or 0,
            proposal_data.get("availability") or "",
            proposal_data.get("attachments") or "",
            "submitted",
            0,
            now,
            now
